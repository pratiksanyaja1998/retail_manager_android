...
public class DefaultTemplate {
    ...
    public static String customer(Invoice invoice) {
        ...
        if (customer.getMobile() != null && !customer.getMobile().equals(""))
            bf.append("\t<tr><td>Mobile Number :&nbsp;&nbsp;&nbsp;&nbsp;" + customer.getMobile() + "</td></tr>\n");
        ...
        if (customer.getGstin() != null && !customer.getGstin().equals(""))
            bf.append("\t<tr><td>GSTIN Number :&nbsp;&nbsp;&nbsp;&nbsp;" + customer.getGstin() + "</td></tr>\n");
...
//        double amt = (invoice.getDiscount() * invoice.getTotal()) / 100;
        ...
        bf.append("<tr class=\"bgcolor\"><td colspan=\"" + 5 + "\">DISSCOUNT(%)</td><td> " + invoice.getDiscount() + " %</td></tr>" +
                gstrow +
                "<tr class=\"bgcolor\"><td colspan=\"" + 5 + "\">TOTAL</td><td>Rs. " + amt + " /-</td></tr>\n" +
                "<tr class=\"bgcolor\"><td colspan=\"2\">TOTAL(in words)</td><td colspan=\"" + 4 + "\">" + NumberToWord.NTOW(Math.round(amt)) + "</td></tr>\n" +
                "</table><br>");
